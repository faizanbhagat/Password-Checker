...
int main() {
    ...
    cout << "Choose 1 to check passwords with default password criteria, or 2 for custom password criteria: ";
    cin >> userSelection;
    cout << endl << endl;
    
    while (userSelection !=2 && userSelection != 1){
        cout << "Error: Please choose 1 to check passwords with default password criteria, or 2 for custom password criteria: ";
        cin >> userSelection;
        cout << endl << endl;
    }
